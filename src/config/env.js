...
const environmentSchema = z.object({
    ...
    UPLOAD_MAX_BYTES: z.coerce.number().int().min(1_024).max(20 * 1024 * 1024)
        .default(5 * 1024 * 1024),
...
export function parseEnv(input = process.env) {
    ...
    try {
        ...
        throw new Error(`Invalid environment configuration: ORIGIN: ${error.message}`);
    }
    return {
        ...
        firebaseServiceAccountFile: result.data.FIREBASE_SERVICE_ACCOUNT_FILE_NAME,
    };
}
